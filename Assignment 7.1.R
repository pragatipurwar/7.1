...
Crimes <- read.csv("C:/Users/Pragati/Desktop/Crimes_-_2001_to_present.csv", header=FALSE)
View(Crimes)
...
#---------------------------
write.csv(model.data, "C:\\Users\\Pragati\\Desktop\\Acad Assignments\\Assignment\\crimemodel.csv")
